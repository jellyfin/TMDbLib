...
namespace TMDbLibTests
{
    ...
    public class ClientFindTests
    {
        ...
        {
            Task<FindContainer> result = _config.Client.Find(FindExternalSource.Imdb, IdHelper.ImdbBruceWillis);
        ...
        {
            Task<FindContainer> result = _config.Client.Find(FindExternalSource.Imdb, IdHelper.ImdbBreakingBadSeason1Episode1Id);
        ...
        {
            Task<FindContainer> result = _config.Client.Find(FindExternalSource.TvDb, IdHelper.TvdbBreakingBadSeason1Id);
            Assert.AreEqual(1, result.Result.TvEpisode.Count);
        ...
        {
            Task<FindContainer> result = _config.Client.Find(FindExternalSource.TvDb, IdHelper.TvdbBreakingBadId);
        ...
        {
            Task<FindContainer> result = _config.Client.Find(FindExternalSource.Imdb, IdHelper.ImdbBreakingBadId);
            Assert.AreEqual(1, result.Result.TvResults.Count);
            Assert.AreEqual(IdHelper.TmdbBreakingBadId, result.Result.TvResults[0].Id);
        }
        ...
        {
            Task<FindContainer> result = _config.Client.Find(FindExternalSource.TvRage, IdHelper.TvRageBreakingBadId);
            Assert.AreEqual(1, result.Result.TvResults.Count);
            Assert.AreEqual(IdHelper.TmdbBreakingBadId, result.Result.TvResults[0].Id);
        }
        ...
        {
            Task<FindContainer> result = _config.Client.Find(FindExternalSource.FreeBaseId, IdHelper.FreebaseBreakingBadId);
            Assert.AreEqual(1, result.Result.TvResults.Count);
            Assert.AreEqual(IdHelper.TmdbBreakingBadId, result.Result.TvResults[0].Id);
        }
        ...
        {
            Task<FindContainer> result = _config.Client.Find(FindExternalSource.FreeBaseMid, IdHelper.FreebaseMidBreakingBadId);
            Assert.AreEqual(1, result.Result.TvResults.Count);
            Assert.AreEqual(IdHelper.TmdbBreakingBadId, result.Result.TvResults[0].Id);
        }
    }

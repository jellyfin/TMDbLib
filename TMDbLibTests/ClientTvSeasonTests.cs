...
namespace TMDbLibTests
{
    public class ClientTvSeasonTests : TestBase
    {
        ...
        public void TestTvSeasonExtrasNone()
        {
            ...
            IgnoreMissingJson(" / images", " / account_states", " / credits", " / external_ids", " / images", " / videos", " / episode_count");
        ...
        public void TestTvSeasonExtrasAccountState()
        {
            ...
            // We will intentionally ignore errors reg. missing JSON as we do not request it
            IgnoreMissingJson(" / credits", " / external_ids", " / images", " / videos", "account_states / id", " / episode_count");
        ...
        public void TestTvSeasonExtrasAll()
        {
            ...
            IgnoreMissingJson("images / id", "account_states / id", "credits / id", "external_ids / id", "videos / id", " / episode_count");
        ...
        public void TestTvSeasonExtrasExclusive()
        {
            ...
            // We will intentionally ignore errors reg. missing JSON as we do not request it
            IgnoreMissingJson(" / images", " / account_states", " / external_ids", " / images", " / videos", " / credits", "images / id", "external_ids / id", "videos / id", "credits / id", "account_states / id", " / episode_count");

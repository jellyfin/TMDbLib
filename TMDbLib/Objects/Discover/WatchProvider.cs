...
/// Available provider IDs change over time, last updated: 2026-04-10.
/// </remarks>
public static class WatchProvider
{
    ...
    public static class MGMPlus
    {
        ...
        public static readonly int[] All = [Standard, AmazonChannel, RokuChannel, AmazonChannelAlt, AppleTVChannel];
    }

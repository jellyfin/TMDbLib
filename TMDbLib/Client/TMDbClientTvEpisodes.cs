...
namespace TMDbLib.Client
{
    public partial class TMDbClient
    {
        ...
        {
            RestQueryBuilder req = new RestQueryBuilder("tv/{id}/season/{season_number}/episode/{episode_number}");
            ...
            ResponseContainer<TvEpisode> response = _client.Get<TvEpisode>(req);
        ...
        {
            RestQueryBuilder req = new RestQueryBuilder("tv/{id}/season/{season_number}/episode/{episode_number}/{method}");
            req.AddUrlSegment("id", tvShowId.ToString(CultureInfo.InvariantCulture));
            req.AddUrlSegment("season_number", seasonNumber.ToString(CultureInfo.InvariantCulture));
            req.AddUrlSegment("episode_number", episodeNumber.ToString(CultureInfo.InvariantCulture));
